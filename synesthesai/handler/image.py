...
class ImageHandler:
    def __init__(self, image_file: BinaryIO) -> None:
        ...
        self.max_tokens = 90
        self.description_prompt = """Write a very brief description of this picture. Focus on specific emotions, aesthetics, and genres. Feel free to add details of any musical genres it may invoke. Write no more than two sentences."""
